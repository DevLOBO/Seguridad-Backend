...
public class EmailUtil {
	...
	public void sendEmailWithAttachment(String username, String password, byte[] img, String key, Date date) throws AddressException, MessagingException, UnsupportedEncodingException {
		MimeMessage message = sender.createMimeMessage();
		
		MimeMessageHelper helper = new MimeMessageHelper(message, true, "UTF-8");
		helper.setTo(username);
		helper.setSubject("Mensaje encriptado");
		helper.setText(buildText(key, date, username, password), true);
	...
	private static String buildText(String key, Date date, String username, String password) {
		String dateFormatted = new SimpleDateFormat("dd/MM/yyyy HH:mm:ss").format(date),
				...
				"        <p class=\"lead\">Te han enviado un mensaje encriptado.</p>\r\n" + 
				"        <hr class=\"my-2\">\r\n" + 
				"		 <ul><li>Nombre de usuario: " + username + "</li>" +
				"		 <li>Contraseña: " + password + "</li>" + 
				"        <li>Tu llave de desencriptación es: " + key + "</li>\r\n" + 
				"		 <li>Fecha de expiración: " + dateFormatted + "</li></ul>" + 
